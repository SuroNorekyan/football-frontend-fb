...
export const AnalyticsPosts: React.FC<AnalyticsProps> = ({ allPosts }) => {
  ...
  const currentPosts = analyticsPosts.slice(indexOfFirstPost, indexOfLastPost);
        ...
        <div className="w-11/12 flex flex-row flex-wrap px-0 lg:px-0 justify-center ">
          ...
          <div className="w-full flex flex-row justify-center">
            <Pagination
              ...
              totalPosts={analyticsPosts.length}
